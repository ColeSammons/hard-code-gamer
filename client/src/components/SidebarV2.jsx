            ...
            <div className={`sidebar-wrapper ${toggle ? "sidebar-lg" : "sidebar-sm"} transition-sidebar`}>
                ...
                <ul className="list-wrapper">
                    ...
                    <li className="dropdown-videos-container">
                        <div className={`sidebar-list ${toggleDropdownStreams ? "active-dropdown-color" : ""} transition-sidebar`} onClick={handleDropdownStreams}>
                                ...
                                <>
                                    {follows ? (
                                        <>
                                            {follows.map((follow) => {
                                                return (
                                                    <Channel avatar={follow.profile_image_url} name={follow.display_name} key={follow.display_name} />
                                                );
                                            })}
                                        </>
                                    ) : (null)}
                    ...
                    <li className="dropdown-videos-container">
                        <div className={`sidebar-list ${toggleDropdownVideos ? "active-dropdown-color" : ""} transition-sidebar`} onClick={handleDropdownVideos}>
                                                ...
                                                return (
                                                    <li key={video.youtubeID}>
                                                        <Link to={`/watchScreen/${video.youtubeID}`} className="channel sidebar-text-expand" key={video.title}>
                                                            <i className="fab fa-youtube fa-lg sidebar-video-icon"></i>
                                                            <div>
